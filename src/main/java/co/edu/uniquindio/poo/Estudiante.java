...
public record Estudiante(String nombres, String apellidos, String numeroIdentificacion, String correo, String telefono,
    ...
    public Estudiante {
        assert nombres != null : "El nombre debe ser diferente de null";
        assert apellidos != null : "El apellido debe ser diferente de null";
        assert numeroIdentificacion != null : "El número de identificación debe ser diferente de null";
